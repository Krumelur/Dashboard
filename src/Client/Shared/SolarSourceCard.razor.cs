	...
	public partial class SolarSourceCard : ComponentBase
	{
		...
		public async Task HandleRefreshClick(MouseEventArgs args)
		{
			...
			var dataSetHousePower = new LineChartDataset<double>
			{
				...
				Data = dataHousePower,
				BackgroundColor = new List<string> { ChartColor.FromRgba(243, 120, 121, 1f) },
				BorderColor = new List<string> { ChartColor.FromRgba(238, 64, 64, 1f) },
				Fill = true,
				PointRadius = 2,
			...
			var dataSetSolarPower = new LineChartDataset<double>
			{
				...
				Data = dataSolarPower,
				Fill = true,
				BackgroundColor = new List<string> { ChartColor.FromRgba(97, 201, 137, 0.7f) },
				BorderColor = new List<string> { ChartColor.FromRgba(28, 180, 91, 0.7f) },
				PointRadius = 2,
				BorderDash = new List<int> { }
			};
