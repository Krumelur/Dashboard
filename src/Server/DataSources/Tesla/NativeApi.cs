using Dashboard.Server.DataSources.Tesla.Responses;
using Flurl;
using Flurl.Http;
...
namespace Dashboard.Server.DataSources.Tesla
{
	/// <summary>
	...
	public class NativeApi
	{
		...
		public NativeApi(string teslaClientId, string teslaClientSecret, string userAgent, int timeoutSeconds)
		{
